...
Working together to create Optimized Testing Solutions for your Team / Product / Organization!
...
##Quality  Strategy
Testing is a critical part of any organization’s success. However, the approach to testing is typically testing after the development is done.
This is one of the main reasons why Testing becomes a bottle-neck for your organization. To add to the problem, because it is done later in the SDLC, the cost of fixing issues found at this sate is huge.
...
* Proposal - Based on the assessment, and the shared understanding of the vision of Quality, create a plan how to build a quality product.
