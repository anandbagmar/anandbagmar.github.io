...
As mentioned in my [earlier post](</blog/december-2012-conferences-waat-taas-it-is/>), I spoke last week in [UNICOM's Next Generation Testing Conference in Bangalore](<http://www.unicomlearning.com/event/seminar/next-generation-testing-conference-bangalore>) on 13th December. My talk was about the "[**_The  What, Why and How of Web Analytics Testing_**](</blog/tags/#waat>)". The slides from the talk are available [here](<http://www.slideshare.net/abagmar/the-what-why-and-how-of-web-analytics-testing>) on slideshare.net. The audio recording of the talk is available [here](<http://db.tt/nS0N6ljG>). (You can download and use a player like VLC to listen to the recording.)  
