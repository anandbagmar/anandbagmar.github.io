---
layout: page
title: "Career Path of a Tester!"
date: 2016-12-08 00:05:00 +0000
categories:
  - blog
tags:
  - "career"
...
I agree with most of the thoughts and also think that the answer to the question is "**_It Depends!_** "
...
The path of the [shift-left](<https://en.wikipedia.org/wiki/Shift_left_testing>) is extremely important and also not easy. You need to apply a different mindset to accomplish activities that helps build a better software even before any code is written.
...
When the software is built right, and the end-user is able to do what is expected from the software you have helped build and test, _**Testing is also very rewarding**_!
