---
layout: page
title: "Automate across Platform, OS, Technologies with TaaS"
date: 2014-02-27 16:29:00 +0000
categories:
  - blog
tags:
  - "bangalore"
...
The slides from the talk are available [here](<http://www.slideshare.net/abagmar/automate-across-platform-os-technologies-with-taas>) on slideshare. You can download the audio recording from the talk from [here](<https://db.tt/DLuwvz4l>). The pictures and video should be available from Agile India 2014 site soon. I will update the links for the same when that becomes available.  
  
\--------   
  
After what seems to be a long time, I am speaking in [Agile India 2014](<http://2014.agileindia.org/>) in Bangalore on  "[Automate across Platform, OS, Technologies with TaaS](<http://present.agileindia.org/schedule/agile-india-2014#session-101-info>)".  
