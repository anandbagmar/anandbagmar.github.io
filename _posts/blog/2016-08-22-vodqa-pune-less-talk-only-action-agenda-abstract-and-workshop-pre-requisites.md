---
layout: page
title: "vodQA Pune - Less Talk, Only Action - Agenda, Abstract and workshop pre-requisites"
date: 2016-08-22 10:53:00 +0000
categories:
  - blog
tags:
  - "bdd"
...
####  Map: [http://goo.gl/maps/KfuJG](<https://goo.gl/maps/KfuJG>)
...
###  _1\. Automating Web Analytics - Why? How?_
...
####  Pre-Reqs: 
  ...
  * Also [refer here](<https://github.com/anandbagmar/WAAT#setup-instructions-for-running-tests-using-appium>) for steps to run Appium tests using WAAT 
...
###  _2\. Performance testing with Gatling for Beginners_
...
###  _4\. Security Testing - Operation Vijay_
...
###  _5\. Automate your Mobile tests with Appium_
...
Pre-Reqs:
  ...
  * Download & install Virtual Box from [here](<https://www.virtualbox.org/wiki/Downloads>)

  * Download the basic version on Genymotion Android Emulator from [here](<https://www.genymotion.com/pricing-and-licensing/>)
    ...
    * Once you download, install Genymotion Android Emulator by following the instructions [here](<https://docs.genymotion.com/Content/01_Get_Started/Installation.htm>)

    * Once you install, open/start Genymotion and click on Add(+) link to add a new virtual device and press Signin and login 

    * Select Android Version 6.0.0 and Device model Google Nexus 5 or 6. For more details follow the instruction mentioned [here](<https://docs.genymotion.com/Content/02_Application/Adding_a_new_virtual_device/Adding%20a%20new_virtual_device.htm?Highlight=add%20virtual%20device>)
...
###  _6\. Increase Automation to REST_
...
###  _8\. Mobile Automation using Espresso_

Pre-Reqs:  


  * Ensure you have Java 7 or beyond, installed on your box. If not you can download it from [here](<http://www.oracle.com/technetwork/java/javase/downloads/jdk7-downloads-1880260.html>) 
  * Download & install Virtual Box from [here](<https://www.virtualbox.org/wiki/Downloads>)
  * Download and install Android Studio from [here](<https://developer.android.com/studio/index.html#downloads>). 
  ...
  * Download the basic version on Genymotion Android Emulator from [here](<https://www.genymotion.com/pricing-and-licensing/>)
    ...
    * Select from available option, Press Next and wait till download finishes.
    * Press start button & you should see emulator running.
    * You’re all set for the event. ![😃](https://mail.google.com/mail/e/1f603)
