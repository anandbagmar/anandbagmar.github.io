---
layout: page
title: "Lessons from a 1-day training engagement - a Trainer perspective"
...
At the end of the exhausting day (both, for the Trainers as well as the Trainees), a couple of things stood out (not in any particular order):
  ...
  * _**What is the "right" Agile QA process?**_
  * _**Roles and responsibilities of a QA on an Agile team**_
_****_
  * _**Sharing case studies and the good & not-so-good experiences around them**_
  * _**Effectiveness of process and practices**_
  * _**Value of asking difficult questions at the right time**_
  * _**Taboo game - playing it, and reflecting on its learnings**_
  * _**What to automate and what NOT to automate?**_
  * _**Discussion around - How do you create / generate Test Data?**_
